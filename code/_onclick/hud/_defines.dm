...
#define ui_crafting	"EAST-2:10,SOUTH+1:23"//CIT CHANGE - moves this over one tile to accommodate for combat mode toggle
#define ui_building "EAST-2:26,SOUTH+2:7"//CIT CHANGE - ditto
#define ui_language_menu "EAST-2:26,SOUTH+1:23"//CIT CHANGE - ditto
